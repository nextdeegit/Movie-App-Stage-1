package com.example.esidemjnr.movieappstage1.adapters;

/**
 * Created by ESIDEM jnr on 10/15/2016.
 */
...
import com.example.esidemjnr.movieappstage1.R;
...
public class MovieAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = mInflater.inflate(R.layout.movie_grid_item, parent, false);
